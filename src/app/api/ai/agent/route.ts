...
8. **bulk_import_employees** — أداة تنفيذية لرفع موظفين دفعة واحدة.
   لما المستخدم يرفع ملف Excel ويقولك "ضيف الموظفين دول":
...
9. **bulk_import_attendance** — أداة تنفيذية لرفع سجلات حضور دفعة واحدة.
   نفس flow rules الـ bulk_import_employees بالضبط. كل صف لازم فيه:
   employee_code (للبحث في موظفي الشركة) + date + status. لو الكود مش
   موجود في النظام، الصف يتجاهل.
